CREATE TABLE `college_db`.`students` (`id` INT NOT NULL , `name` VARCHAR(30) NOT NULL , `age` INT NOT NULL , `department` VARCHAR(30) NOT NULL , `grade` INT NOT NULL ) ENGINE = InnoDB;
